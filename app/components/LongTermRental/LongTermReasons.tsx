  ...
  return (
    <section className="bg-surface py-14">
      <div className={sectionContainer}>
        ...
        <div className="mt-10 overflow-hidden rounded-2xl border border-border/70 bg-card p-6 sm:p-8">
          <div className="flex h-full flex-col items-center gap-8 sm:flex-row sm:justify-center">
            ...
            <div className="flex w-2xs items-center gap-3 rounded-2xl bg-pl px-5 py-4 shadow-md ring-1 ring-p/10">
