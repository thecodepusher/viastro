  ...
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-7xl px-6 py-24 sm:pt-32 lg:px-8 lg:py-40">
        <h2 className="mb-20 text-center text-3xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-4xl">
          {title}
        </h2>

        <div className="grid md:grid-cols-2 space-x-10 space-y-10">
          {faqs.map((faq) => (
